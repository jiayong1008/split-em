                           ...
                           <div class="tp-hero__content-box text-center z-index-3">
                              <div class="tp-hero__title-box p-relative">
                                 <h2 class="tp-hero__hero-title tp-title-anim">
                                    Pay Less For Every Subscription
                                 </h2>
                  ...
                  <div class="row">
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".4s">
                        <div class="tp-service__item mb-30">
                           ...
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-orange-color"><a href="service-details.html">AI Data Analysis</a></h3>
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".6s">
                        <div class="tp-service__item mb-30">
                           ...
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-theme-color"><a href="service-details.html">Machine Learning</a></h3>
                              <p>Lorem Ipsum is simply dummy text <br>
                                 of the printing</p>
                           </div>
                           <div class="tp-service__link">
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                        <div class="tp-service__item mb-30">
                           ...
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-purple-color"><a href="service-details.html">Data Visualization</a></h3>
                              <p>Lorem Ipsum is simply dummy text <br>
                                 of the printing</p>
                           </div>
                           <div class="tp-service__link">
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".8s">
                        <div class="tp-service__item mb-30">
                           ...
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-green-color"><a href="service-details.html">Business Intelligence</a></h3>
                              <p>Lorem Ipsum is simply dummy text <br>
                                 of the printing</p>
                           </div>
                           <div class="tp-service__link">
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                        <div class="tp-service__item mb-30">
                           ...
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-yellow-color"><a href="service-details.html">Artificial Intelligence</a></h3>
                              <p>Lorem Ipsum is simply dummy text <br>
                                 of the printing</p>
                           </div>
                           <div class="tp-service__link">
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                        <div class="tp-service__dashboard" data-background="assets/img/service/sv-bg.jpg">
                           <div class="tp-service__top-content">
                              ...
                              <a class="tp-btn-orange tp-btn-hover alt-color-white" href="project-details.html">
                                 <span>Work with Us</span>
                                 <b></b>
                              </a>
                           </div>
                           <div class="tp-service__dashdboard-sm-img">
                              <img class="wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".7s" src="assets/img/service/sv-dashbord.png" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
                                       ...
                                       <div class="tp-project__item d-flex align-items-center">
                                          ...
                                          <div class="tp-project__content">
                                             ...
                                             <div class="tp-project__title-box">
                                                <h4 class="tp-project__title-sm"><a href="project-details.html">Muckup Design</a></h4>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          ...
                                          <div class="tp-project__content">
                                             ...
                                             <div class="tp-project__title-box">
                                                <h4 class="tp-project__title-sm"><a href="project-details.html">3d Design</a></h4>
                                                <p>Excepteur sint occaecat cupidatat officia non
                                                   proident, sunt in culpa qui deserunt mollit anim
                                                   id est laborum.
                                                </p>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          ...
                                          <div class="tp-project__content">
                                             ...
                                             <div class="tp-project__title-box">
                                                <h4 class="tp-project__title-sm"><a href="project-details.html">App Design</a></h4>
                                                <p>Excepteur sint occaecat cupidatat officia non
                                                   proident, sunt in culpa qui deserunt mollit anim
                                                   id est laborum.
                                                </p>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          ...
                                          <div class="tp-project__content">
                                             ...
                                             <div class="tp-project__title-box">
                                                <h4 class="tp-project__title-sm"><a href="project-details.html">Graphic Design</a></h4>
                                                <p>Excepteur sint occaecat cupidatat officia non
                                                   proident, sunt in culpa qui deserunt mollit anim
                                                   id est laborum.
                                                </p>
                  ...
                  <div class="row">
                     <div class="col-xl-5 col-lg-5 order-1 order-lg-1">
                        ...
                        <div class="tp-rank__btn wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                           <a class="tp-btn tp-btn-hover alt-color-black" href="service-details.html">
                           ...
                           <div class="row">
                              <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                                 <div class="tp-price__item p-relative">
                                    ...
                                    <div class="tp-price__btn tp-btn-price">
                                       ...
                                       <a href="price.html">Purchase Now <i class="fal fa-arrow-right"></i></a>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                                 <div class="tp-price__item active p-relative">
                                    ...
                                    <div class="tp-price__title-box">
                                       <h4 class="tp-price__title-sm">Advanced</h4>
                                       <p>Customized anything in anytime</p>
                                    </div>
                                    <div class="tp-price__feature">
                                       <ul>
                              ...
                              <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                                 <div class="tp-price__item p-relative">
                                    ...
                                    <div class="tp-price__title-box">
                                       <h4 class="tp-price__title-sm">For Team</h4>
                                       <p>Customized anything in anytime</p>
                                    </div>
                                    <div class="tp-price__feature">
                                       <ul>
                     ...
                     <div class="row align-items-center">
                        <div class="col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                           <div class="tp-copyright__text">
                              <span>© {{ date("Y") }} Split'em. All rights reserved.</span>
                           </div>
                        </div>
